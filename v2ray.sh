...
wget -O ${PWD}/v2ray.zip https://github.com/SagerNet/v2ray-core/releases/download/${TAG}/${V2RAY_FILE} > /dev/null 2>&1
wget -O ${PWD}/v2ray.zip.dgst https://github.com/SagerNet/v2ray-core/releases/download/${TAG}/${DGST_FILE} > /dev/null 2>&1
